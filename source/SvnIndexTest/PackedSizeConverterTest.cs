...
namespace SvnIndexTest
{
    ...
    public class PackedSizeConverterTest
    {
        ...
        public void FromSortableString()
        {
            ...
            Assert.AreEqual(999 * 1024, PackedSizeConverter.FromSortableString(PackedSizeConverter.ToSortableString(999 * 1024)));
            Assert.AreEqual(999 * 1024 * 1024, PackedSizeConverter.FromSortableString(PackedSizeConverter.ToSortableString(999 * 1024 * 1024)));
            Assert.AreEqual(1 *1024 * 1024 * 1024, PackedSizeConverter.FromSortableString(PackedSizeConverter.ToSortableString(1 * 1024 * 1024 * 1024)));
        }
    }
}
